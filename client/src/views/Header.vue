            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><RouterLink class="nav-link" to="/dashboard" v-if="authStore.isAuthenticated">Dashboard</RouterLink></li>
                        <li class="nav-item"><RouterLink class="nav-link" to="/blog-list" v-if="authStore.isAuthenticated">Blog</RouterLink></li>
